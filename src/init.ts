...
export interface InitArgs {
  ...
  worktrees?: Array<{ name: string; path: string; description?: string }>
}
...
export const INIT_TOOL_DESCRIPTION =
...
export function runInit(anchor: string, args: InitArgs): string {
